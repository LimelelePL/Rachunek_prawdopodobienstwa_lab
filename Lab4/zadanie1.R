...
#a
a <- runif(5000)
hist(a, probability = TRUE, main = "Histogram U(1,0)")
d1 <- density(a)
plot(d1, main = "Estymator jądrowy gęstości dla U(0,1)")


#b
b <- rnorm(3000, 100, 15)
hist(b, probability = TRUE, main = "Histogram dla nrom(100,15)")
d2<- density(b)
plot(d2, main = "Estymator jądrowy gęstościa dla norm(100,15)")